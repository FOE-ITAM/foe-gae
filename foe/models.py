...
class Comite(models.Model):
    ...
    foto = models.ImageField(verbose_name='Foto de perfil', blank=True,
                             null=True,
                             help_text='El nombre del archivo no debe contener acentos ni ñ')
...
class DatosBancarios(models.Model):
    ...
    cuenta = models.CharField(verbose_name='Número de Cuenta',
                              max_length=30)
    CLABE = models.CharField(verbose_name='CLABE',
                             max_length=30)
    tarjeta = models.CharField(verbose_name='Número de tarjeta',
                               max_length=30,
                               blank=True, null=True,
                               help_text='Este campo no es obligatorio')
